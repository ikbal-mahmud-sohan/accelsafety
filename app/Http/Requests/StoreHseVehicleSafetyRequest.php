...
class StoreHseVehicleSafetyRequest extends FormRequest
{
    /**
    ...
    public function rules(): array
    {
        return [
            ...
            'brake_oil_level_unsatisfactory' =>'nullable|string',
            ...
            'signature_of_inspector' => 'sometimes|array',
            'signature_of_inspector.*' => 'image|mimes:jpeg,png,jpg,gif,svg|max:2048',
            'inspector_name' =>'nullable|string',
            'inspector_designation' =>'nullable|string',
            'signature_of_drivers' => 'sometimes|array',
            'signature_of_drivers.*' => 'image|mimes:jpeg,png,jpg,gif,svg|max:2048',
        ];
    }
}
