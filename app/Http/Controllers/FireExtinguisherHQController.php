...
class FireExtinguisherHQController extends Controller
{
    public function index(Request $request)
    {
        ...
        $query = FireExtinguisherHQ::query()
    ...
    public function store(Request $request)
    {
        $validated = $request->validate([
            'tag_no' => 'required|unique:fire_extinguisher_h_q_s,tag_no',
            'type' => 'required',
            'location' => 'required',
        ]);

        $data = FireExtinguisherHQ::create($validated);
        return response()->json([
    ...
    {
        try {
            $data = FireExtinguisherHQ::findOrFail($id);
            return response()->json([
                'data' => $data,
            ]);
