...
use App\Models\EmergencyAlarmVisibleChecklist;
use Carbon\Carbon;
use Illuminate\Http\Request;

class EmergencyAlarmVisibleChecklistController extends Controller
{
    ...
    {
        return response()->json([
            'emergency_alarm_visible' => EmergencyAlarmVisible::all(),
        ]);
    }
    ...
    public function store(Request $request)
    {
        $validated = $request->validate([
            'emergency_alarm_visible_id' => 'required|numeric|exists:emergency_alarm_visibles,id',
        ...
        // Check if a record already exists for the same emergency_alarm_visible_id and month
        $exists = EmergencyAlarmVisibleChecklist::where('emergency_alarm_visible_id', $validated['emergency_alarm_visible_id'])
        ...
        $data = EmergencyAlarmVisibleChecklist::create($validated);
    ...
    {
        try {
            $data = EmergencyAlarmVisibleChecklist::with('emergency_alarm_visible')->findOrFail($id);
            return response()->json([
                'data' => $data,
            ]);
    ...
    public function update(Request $request, $id)
    {
        ...
        $record = EmergencyAlarmVisibleChecklist::findOrFail($id);
    ...
    public function destroy($id){
        try {
            $data=  EmergencyAlarmVisibleChecklist::findOrFail($id);
            $data->delete();
            return response()->json([
