...
return new class extends Migration
{
    ...
    {
        Schema::create('fire_extinguisher_h_q_checklists', function (Blueprint $table) {
            $table->id();
            $table->unsignedInteger('fire_extinguisher_hq_id');
    ...
    {
        Schema::dropIfExists('fire_extinguisher_h_q_checklists');
    }
};
