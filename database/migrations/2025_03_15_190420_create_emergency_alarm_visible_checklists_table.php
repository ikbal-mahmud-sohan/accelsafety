...
return new class extends Migration
{
    ...
    {
        Schema::create('emergency_alarm_visible_checklists', function (Blueprint $table) {
            $table->id();
            $table->unsignedInteger('emergency_alarm_visible_id');
    ...
    {
        Schema::dropIfExists('emergency_alarm_visible_checklists');
    }
};
