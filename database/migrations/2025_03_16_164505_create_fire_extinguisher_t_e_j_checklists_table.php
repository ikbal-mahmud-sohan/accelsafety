...
return new class extends Migration
{
    ...
    {
        Schema::create('fire_extinguisher_t_e_j_checklists', function (Blueprint $table) {
            $table->id();
            $table->unsignedInteger('fire_extinguisher_tej_id');
    ...
    {
        Schema::dropIfExists('fire_extinguisher_t_e_j_checklists');
    }
};
