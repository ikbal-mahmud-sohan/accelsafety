...
return new class extends Migration
{
    ...
    {
        Schema::create('fire_extinguisher_c_t_g_checklists', function (Blueprint $table) {
            $table->id();
            $table->unsignedInteger('fire_extinguisher_ctg_id');
    ...
    {
        Schema::dropIfExists('fire_extinguisher_c_t_g_checklists');
    }
};
